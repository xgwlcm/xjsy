! function() {
	...
	function e() {
		...
		.call.apply(n, [console, "[ROCKET LOADER] "].concat(t));
		var n
	}
	...
	var A = "http://www.w3.org/2000/svg",
		...
		k = void 0 !== document.createElement("script")
		.noModule,
		I = function() {
			var t = window;
	...
	instanceof Array && function(t, e) {
		...
		return Object.defineProperty(t.prototype, "hasItems", {
			...
			var n = this,
				r = e.filter,
				o = e.mutate;
			Array.prototype.slice.call(t.querySelectorAll("script"))
				.filter(r)
				.reverse()
				.forEach(function(t) {
		...
		return t.prototype.enable = function(t) {
			...
			n && i(n) && n.hasAttribute("async") ? (r = e ? _ : L)
				.call.apply(r, [document].concat(t)) : this.buffer += t.map(String)
				.join(e ? "\n" : "");
			var r
		}, t
	}(), j = function() {
